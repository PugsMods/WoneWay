...
public class WoneWayBlocks {
    ...
    //BLOCKS
     ...
     _WOOL"seethrough_pink_wool"
     ON"seethrough_piston"
     OL"seethrough_podzol"
     SHED_ANDESITE"seethrough_polished_andesite"
     SHED_BASALT"seethrough_polished_basalt"
     SHED_BLACKSTONE"seethrough_polished_blackstone"
     SHED_BLACKSTONE_BRICKS"seethrough_polished_blackstone_bricks"
     SHED_DIORITE"seethrough_polished_diorite"
     SHED_GRANITE"seethrough_polished_granite"
     MARINE"seethrough_prismarine"
     MARINE_BRICKS"seethrough_prismarine_bricks"
     KIN"seethrough_pumpkin"
     LE_CONCRETE"seethrough_purple_concrete"
     LE_CONCRETE_POWDER"seethrough_purple_concrete_powder"
     LE_GLAZED_TERRACOTTA"seethrough_purple_glazed_terracotta"
     LE_SHULKER_BOX"seethrough_purple_shulker_box"
     LE_STAINED_GLASS"seethrough_purple_stained_glass"
     LE_TERRACOTTA"seethrough_purple_terracotta"
     LE_WOOL"seethrough_purple_wool"
     UR_BLOCK"seethrough_purpur_block"
     UR_PILLAR"seethrough_purpur_pillar"
     TZ_BLOCK"seethrough_quartz_block"
     TZ_BRICKS"seethrough_quartz_bricks"
     TZ_PILLAR"seethrough_quartz_pillar"
     CONCRETE"seethrough_red_concrete"
     CONCRETE_POWDER"seethrough_red_concrete_powder"
     GLAZED_TERRACOTTA"seethrough_red_glazed_terracotta"
     MUSHROOM_BLOCK"seethrough_red_mushroom_block"
     NETHER_BRICKS"seethrough_red_nether_bricks"
     SAND"seethrough_red_sand"
     SANDSTONE"seethrough_red_sandstone"
     SHULKER_BOX"seethrough_red_shulker_box"
     STAINED_GLASS"seethrough_red_stained_glass"
     TERRACOTTA"seethrough_red_terracotta"
     WOOL"seethrough_red_wool"
     TONE_BLOCK"seethrough_redstone_block"
     TONE_LAMP"seethrough_redstone_lamp"
     TONE_ORE"seethrough_redstone_ore"
     ATING_COMMAND_BLOCK"seethrough_repeating_command_block"
     AWN_ANCHOR"seethrough_respawn_anchor"
     "seethrough_sand"
     STONE"seethrough_sandstone"
     LANTERN"seethrough_sea_lantern"
     OMLIGHT"seethrough_shroomlight"
     KER_BOX"seethrough_shulker_box"
     E_BLOCK"seethrough_slime_block"
     HING_TABLE"seethrough_smithing_table"
     ER"seethrough_smoker"
     TH_QUARTZ"seethrough_smooth_quartz"
     TH_RED_SANDSTONE"seethrough_smooth_red_sandstone"
     NE"seethrough_smooth_sandstone"
