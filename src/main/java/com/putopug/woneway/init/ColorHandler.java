...
import static net.minecraftforge.client.ForgeHooksClient.onBlockColorsInit;

@OnlyIn(Dist.CLIENT)
public class ColorHandler {
    // FORGE: Use RegistryDelegates as non-Vanilla block ids are not constant
    private final java.util.Map<net.minecraftforge.registries.IRegistryDelegate<WoneWayBlocks>, IBlockColor> blockColors = new java.util.HashMap<>();
    private final Map<Block, Set<Property<?>>> coloringStates = Maps.newHashMap();

    public static ColorHandler createDefault() {
        ColorHandler blockcolors = new ColorHandler();
