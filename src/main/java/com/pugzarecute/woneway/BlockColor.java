...
public class BlockColor {
    ...
    public static void setupBlockColors(ColorHandlerEvent.Block event) {
        ...
        colors.register((state, world, pos, tint) -> world != null && pos != null ? BiomeColors.getAverageFoliageColor                                                                                                                                 (world, pos) : FoliageColors.getDefaultColor(), WoneWayBlocks.LEAVES.getEntries().stream().map(RegistryObject::get)::iterator);
