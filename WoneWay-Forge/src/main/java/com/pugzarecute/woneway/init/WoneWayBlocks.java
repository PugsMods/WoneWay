...
public class WoneWayBlocks {
    ...
    public static void init() {
        ...
        registerItemAndBlock("seethrough_magenta_wool");registerItemAndBlock("seethrough_orange_wool");registerItemAndBlock("seethrough_pink_wool");registerItemAndBlock("seethrough_purple_wool");registerItemAndBlock("seethrough_red_wool");
